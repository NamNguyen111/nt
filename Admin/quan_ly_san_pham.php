        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                    <form class="form-inline" id="yw0" action="quan_ly_san_pham.php" method="get">
                        <input class="" placeholder="Tên sản phẩm" style="height:35px;" name="tim_kiem_ten_san_pham" id="Product_name" type="text" maxlength="300" />
                        <input class="" placeholder="Mã sản phẩm" style="max-width: 130px;height:35px;" name="tim_kiem_ma_san_pham" id="Product_code" type="text" maxlength="50" />
                        ...
                        <select class="" name="tim_kiem_trang_thai" id="Product_status" style="height:35px;">
                        ...
                        <select class="" name="tim_kiem_con_hang" id="Product_state" style="height:35px;">
                        ...
                        <select class="" name="tim_kiem_danh_muc" id="Product_product_category_id" style="height:35px;">
                        ...
                        <tbody>
                            ...
                            <?php foreach($products as $product){ ?>
                                <tr class="odd">
                                    ...
                                    <a class="fa-solid fa-pen-to-square" href="suasanpham.php?id=<?php echo($product['id']) ?>"></a>&ensp;<a class="fa-solid fa-trash" href="xoasanpham.php?id=<?php echo($product['id']) ?>"></a>
                                    </td>
                                </tr>
                            <?php } 
