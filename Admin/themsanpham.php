        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                    <form class="form-horizontal" id="category-form" action="themsanphamprocess.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="span10 col-sm-12" style="height: 40px;" name="ma_danh_muc" id="ProductCategories_status">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="span30 col-sm-12" style="height: 40px;" name="ma_hang" id="ProductCategories_status">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="span10 col-sm-12" style="height: 40px;" name="hien_thi" id="ProductCategories_status">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="tinh_trang" id="ProductCategories_showinhome" value="1" type="checkbox" /> <i style="color: rgba(89, 89, 89, 0.503);">Chọn nếu còn hàng</i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="span12 col-sm-12" style="height: 300px;" name="mo_ta_van_tat" id="ProductInfo_product_sortdesc"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="span12 col-sm-12" style="height: 300px;" name="mo_ta" id="ProductInfo_product_sortdesc"></textarea>
                                    </div>
                                </div>
                            </div>
